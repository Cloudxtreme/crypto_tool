...
public final class ReportKeys {
    ...
    public static final Font LABELS_FONT = new Font("Serif", Font.BOLD, 45);
    public static final Color LABELS_FOREGROUND_COLOR = Color.red;

    // Result Label
    public static final int RESULT_LABEL_X_POSITION = GUITools.getRelativeValue(REPORT_FRAME_WIDTH, 5);
    ...
    public static final int RESULT_LABEL_HEIGHT = GUITools.getRelativeValue(REPORT_FRAME_HEIGHT, 20);
    public static final String RESULT_LABEL_TEXT = LanguageTools.translate("result.label.text");

    // Time Label
    public static final int TIME_LABEL_X_POSITION = GUITools.getRelativeValue(REPORT_FRAME_WIDTH, 30);
    public static final int TIME_LABEL_Y_POSITION = GUITools.getRelativeValue(REPORT_FRAME_HEIGHT, 30);
    public static final int TIME_LABEL_WIDTH = GUITools.getRelativeValue(REPORT_FRAME_WIDTH, 50);
    public static final int TIME_LABEL_HEIGHT = GUITools.getRelativeValue(REPORT_FRAME_HEIGHT, 15);
    public static final String MILLISECONDS = LanguageTools.translate("milliseconds");

    // Full Report Button
    public static final int FULL_REPORT_BUTTON_X_POSITION = GUITools.getRelativeValue(REPORT_FRAME_WIDTH, 87);
