...
public final class RegistrationKeys {
    ...
    // Registration Panel
    public static final Color REGISTRATION_PANEL_BACKGROUND_COLOR = Color.gray;
    public static final Color REGISTRATION_PANEL_FOREGROUND_TEXT_COLOR = Color.white;

    // Registration Information Label
    public static final int REGISTRATION_INFORMATION_LABEL_X_POSITION =
            GUITools.getRelativeValue(REGISTRATION_FRAME_WIDTH, 25);
    ...
    public static final int REGISTRATION_INFORMATION_LABEL_HEIGHT =
            GUITools.getRelativeValue(REGISTRATION_FRAME_HEIGHT, 7);
    public static final String REGISTRATION_INFORMATION_LABEL_TEXT =
            LanguageTools.translate("registration.information.label");
    public static final Font REGISTRATION_INFORMATION_LABEL_FONT = new Font("Serif", Font.PLAIN, 18);
    ...
    public static final Font FIRST_NAME_LABEL_FONT = REGISTRATION_INFORMATION_LABEL_FONT;
    ...
    public static final Font LAST_NAME_LABEL_FONT = REGISTRATION_INFORMATION_LABEL_FONT;
    ...
    public static final Font GROUP_LABEL_FONT = REGISTRATION_INFORMATION_LABEL_FONT;
